...
function Services() {
  return (
   ...
   ">
    ...
    ">
       <div className="header flex items-center flex-col gap-4 mb-8  ">
        ...
        <div className="items-wrapper lg:flex flex-col gap-y-4  lg:w-[72%]  relative py-8 lg:py-4 
   ...
   after:bg-right after:z-[-1] ">
        ...
        <div className="items-left  lg:flex justify-start gap-x-6  pb-4 px-8 space-y-4 lg:space-y-2 lg:pl-[70px] lg:pt-[55px]">
            <motion.div
        ...
        <div className="items-right lg:flex justify-end gap-x-6  px-8  space-y-4 lg:space-y-2 lg:pr-[70px] lg:pb-[55px]">
